...
public class CentralStore_Login_Logout extends QCStore
{
		...
		try{
			...
			//ExcelNew TestData = new ExcelNew(System.getProperty("user.dir")+prop.getProperty("QC_Store_NewLoan_Test_data_sheet_path")+FileName+".xls");  		 
				...
				{		
					...
					username = prop.getProperty("Central_UserName");
					password = prop.getProperty("Central_Password");
					store_id = prop.getProperty("Central_StoreId");
					...
					{	
						...
						test.log(LogStatus.INFO,"******** Central Store login has started ********");
