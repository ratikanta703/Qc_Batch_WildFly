...
public class RQC_DC_Deposit extends QCStore{
	...
	public static void dc_depositDropDown(String SSN,String AppURL) throws InterruptedException
	{
		...
		{		
			...
			if(SSN.equals(RegSSN))
			{
				...
				loan_nbr= driver.findElement(locator(Rprop.getProperty("loan_nbr"))).getText();
				test.log(LogStatus.PASS, "Loan Number is" + loan_nbr);
				driver.findElement(locator(Rprop.getProperty("clear_go"))).click();
				...
				if(ESign_CollateralType.equalsIgnoreCase("ACH"))
				{
					...
					driver.findElement(locator(Rprop.getProperty("clear_finish"))).click();
				...
				if(ESign_CollateralType.equalsIgnoreCase("CHECK"))
				{
					...
					driver.findElement(By.id("go_Button")).click();
					test.log(LogStatus.PASS, "Click on GO Button after transaction type selection ");								 
					driver.findElement(locator(Rprop.getProperty("deposite_ilp_dstype"))).sendKeys(Deposit_Type);								 
