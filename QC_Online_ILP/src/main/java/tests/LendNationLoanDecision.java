...
public class LendNationLoanDecision extends QCStore{
	  ...
	  public static void utilp_loandecision(String SSN,String AppURL) throws Exception
	  ...
	  public static void nmilp_loandecision(String SSN,String AppURL) throws Exception
	  
	  {
			...
			Thread.sleep(1000);
			  ...
			  Thread.sleep(500);
			                                                           //*[@id="ilp26"]/div/div[3]/div                                          
			  String No_Of_Installment =  driver.findElement(By.xpath("//*[@id='ilp13']/div/div[3]/div")).getText();
			  test.log(LogStatus.PASS, "No Of Installment is : " +No_Of_Installment);
			  
			  Thread.sleep(500);
			
			  String First_Payment_Amt = driver.findElement(By.xpath("//*[@id='ilp13']/div/div[4]/div")).getText();
			  test.log(LogStatus.PASS, "First Payment Amt is : " +First_Payment_Amt);
			  
              Thread.sleep(500);
			  
			  String First_Payment_Date = driver.findElement(By.xpath("//*[@id='ilp13']/div/div[5]/div")).getText();
			  test.log(LogStatus.PASS, "First Payment Date is : " +First_Payment_Date);
			  
              Thread.sleep(500);
			  
			  String Future_Payment = driver.findElement(By.xpath("//*[@id='ilp13']/div/div[6]/div")).getText();
			  test.log(LogStatus.PASS, "Future_Payment is : " +Future_Payment);
			  
              Thread.sleep(500);
			  
			  String Payment_Frequency = driver.findElement(By.xpath("//*[@id='ilp13']/div/div[7]/div")).getText();
			  test.log(LogStatus.PASS, "Payment_Frequency is : " +Payment_Frequency);
			  
              Thread.sleep(500);
                                                         
			  String Apr = driver.findElement(By.xpath("//*[@id='ilp13']/div/div[8]/div")).getText();
			  test.log(LogStatus.PASS, "APR Amount is : " +Apr);
			  
			  Thread.sleep(500);
			  
			  driver.findElement(By.xpath("//*[@id='ilp13']/div/div[9]/button")).click();
			  test.log(LogStatus.PASS, "Clicked on Option 1 Select tab");
	  ...
	  
	  {
			...
			Thread.sleep(1000);
			  ...
			  Thread.sleep(500);
			                                                           //*[@id="ilp26"]/div/div[3]/div                                           
			  String No_Of_Installment =  driver.findElement(By.xpath("//*[@id='ilp26']/div/div[3]/div")).getText();
			  test.log(LogStatus.PASS, "No Of Installment is : " +No_Of_Installment);
			  
			  Thread.sleep(500);
			  
			  String First_Payment_Amt = driver.findElement(By.xpath("//*[@id='ilp26']/div/div[4]/div")).getText();
			  test.log(LogStatus.PASS, "First Payment Amt is : " +First_Payment_Amt);
			  
              Thread.sleep(500);
			  
			  String First_Payment_Date = driver.findElement(By.xpath("//*[@id='ilp26']/div/div[5]/div")).getText();
			  test.log(LogStatus.PASS, "First Payment Date is : " +First_Payment_Date);
			  
              Thread.sleep(500);
			  
			  String Future_Payment = driver.findElement(By.xpath("//*[@id='ilp26']/div/div[6]/div")).getText();
			  test.log(LogStatus.PASS, "Future_Payment is : " +Future_Payment);
			  
              Thread.sleep(500);
			  
			  String Payment_Frequency = driver.findElement(By.xpath("//*[@id='ilp26']/div/div[7]/div")).getText();
			  test.log(LogStatus.PASS, "Payment_Frequency is : " +Payment_Frequency);
			  
              Thread.sleep(500);
			  
			  String Apr = driver.findElement(By.xpath("//*[@id='ilp26']/div/div[8]/div")).getText();
			  test.log(LogStatus.PASS, "APR Amount is : " +Apr);
			  
			  Thread.sleep(500);
			  
			  driver.findElement(By.xpath("//*[@id='ilp26']/div/div[9]/button")).click();
			  test.log(LogStatus.PASS, "Clicked on Option 1 Select tab");
...
public static void ililp_loandecision(String SSN,String AppURL) throws Exception
	  
	  {
			...
			Thread.sleep(1000);
			 ...
			 // Thread.sleep(30000);
			  ...
			  String No_Of_Installment =  driver.findElement(By.xpath("//*[@id='ilp12']/div/div[3]/div")).getText();
			  test.log(LogStatus.PASS, "No Of Installment is : " +No_Of_Installment);
			  
			  Thread.sleep(500);
			
			  String First_Payment_Amt = driver.findElement(By.xpath("//*[@id='ilp12']/div/div[4]/div")).getText();
			  test.log(LogStatus.PASS, "First Payment Amt is : " +First_Payment_Amt);
			  
              Thread.sleep(500);
            
			  String First_Payment_Date = driver.findElement(By.xpath("//*[@id='ilp12']/div/div[5]/div")).getText();
			  test.log(LogStatus.PASS, "First Payment Date is : " +First_Payment_Date);
			  
              Thread.sleep(500);
            
			  String Future_Payment = driver.findElement(By.xpath("//*[@id='ilp12']/div/div[6]/div")).getText();
			  test.log(LogStatus.PASS, "Future_Payment is : " +Future_Payment);
			  
              Thread.sleep(500);
            
			  String Payment_Frequency = driver.findElement(By.xpath("//*[@id='ilp12']/div/div[7]/div")).getText();
			  test.log(LogStatus.PASS, "Payment_Frequency is : " +Payment_Frequency);
			  
              Thread.sleep(500);
          
			  String Apr = driver.findElement(By.xpath("//*[@id='ilp12']/div/div[8]/div")).getText();
			  test.log(LogStatus.PASS, "APR Amount is : " +Apr);
			  
			  Thread.sleep(500);
			
			  driver.findElement(By.xpath("//*[@id='ilp12']/div/div[9]/button")).click();
			  test.log(LogStatus.PASS, "Clicked on Option 1 Select tab");
