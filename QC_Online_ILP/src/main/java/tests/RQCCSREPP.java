...
public class RQCCSREPP extends QCStore {
					...
					{		
					   ...
					   driver.switchTo().frame("topFrame");
					    ...
					    Thread.sleep(2000);					  
						 ...
						 test.log(LogStatus.PASS, "Tender Type select as  :"+TenderType);
						 Thread.sleep(500);
						 String PaymentAmount=driver.findElement(By.name("payDownAmt")).getAttribute("value");
						 test.log(LogStatus.PASS, "Payment amount is  :"+PaymentAmount);
						 Thread.sleep(500);
						 driver.findElement(By.name("tenderAmt")).sendKeys(PaymentAmount);
						...
						//================================
						 ...
						 if(driver.findElement(By.name("checkyes")).isDisplayed())
							{
							 test.log(LogStatus.PASS, "<FONT color=green style=Arial> EPP Transaction Completed Successfully");
