	...
	try{
			...
			{		
				...
				if(SSN.equals(RegSSN))
				{
					...
					String CardTwo = TestData.getCellData(sheetName,"CardTwo",row);
					...
					//driver.findElement(By.xpath("//*[@id='cardType2']/select")).sendKeys("NEW CARD");
					...
					Thread.sleep(1000);
			//Extra Line For DebitCard : CardTwo
			//=========================================================================	
					try{	
					driver.findElement(By.name("crditNbrFirst")).sendKeys(CardTwo);
					test.log(LogStatus.PASS, "Card number is :" + CardTwo);
					Thread.sleep(1000);
					driver.findElement(By.name("requestBean.password")).sendKeys(PIN);
					test.log(LogStatus.PASS, "Pin is entered as "+ PIN);
					driver.findElement(By.name("finish")).click();
...
break;
		...
		if(i==3)
		{
			test.log(LogStatus.FAIL, " Partial Payment setup is failed");
			Assert.assertTrue(false);
	...
	try{
			...
			//================================================================================
					...
					if(driver.findElement(By.name("checkno")).isDisplayed())
					{
					test.log(LogStatus.PASS, "Payment transaction is successfull");
					}
					test.log(LogStatus.PASS,"****************************************");
					break;
