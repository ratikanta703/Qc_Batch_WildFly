...
public class QCCSR_Deposit extends QCStore{
	
	public static void dc_depositDropDown(String SSN,String AppURL) throws InterruptedException
	{
		...
		{		
			...
			if(SSN.equals(RegSSN))
			{
				...
				test.log(LogStatus.INFO, "************* Debit Card Deposit from CSR has initiated **************");
				...
				if(ESign_CollateralType.equalsIgnoreCase("DEBIT CARD"))
				{
					...
					Thread.sleep(2000);
					test.log(LogStatus.PASS, "<FONT color=green style=Arial> Debit Card Deposit From CSR Portal Completed Successfully ");
	...
	public static void mopdldepositDropDown(String SSN,String AppURL)
	{
		int i;
		for(i=0;i<3;i++)
		{
						   ...
						   driver.switchTo().defaultContent();
								...
								
							{
								for( String winHandle1 : driver.getWindowHandles())
								{
								 ...
								 test.log(LogStatus.PASS, "Clicked on Finish ACH Button");
								 Thread.sleep(5000);
								...
								test.log(LogStatus.PASS, "<FONT color=green style=Arial> ACH Deposit from CSR is successfull ");
								//test.log(LogStatus.PASS, ESign_CollateralType+" Deposit from CSR is successfull");
								test.log(LogStatus.PASS, "********************************************** ");

							}
							}
                             if(StateID.equalsIgnoreCase("NV"))
								
							{
								...
								//test.log(LogStatus.PASS, MarkupHelper.createLabel(ESign_CollateralType+" Deposit from CSR is successfull", ExtentColor.GREEN));
								test.log(LogStatus.PASS, "<FONT color=green style=Arial> Deposit from CSR is successfull ");
								//test.log(LogStatus.PASS, ESign_CollateralType+" Deposit from CSR is successfull");
								test.log(LogStatus.PASS, "********************************************** ");
						   ...
						   driver.switchTo().defaultContent();
								...
								
							{
								for( String winHandle1 : driver.getWindowHandles())
								{
								 ...
								 String DepositInstAmount = driver.findElement(By.xpath("//*[@id='AchDepScreen']/table/tbody/tr[4]/td/table/tbody/tr[2]/td[5]")).getText();
								 test.log(LogStatus.PASS, " Deposit Installment Amount is :" +DepositInstAmount);
								 driver.findElement(By.name("finish")).click();
								 test.log(LogStatus.PASS, "Clicked on Finish Deposit Button");
	...
	public static void nvpdldeposit(String SSN,String AppURL)
	{
		int i;
		for(i=0;i<3;i++)
		{
