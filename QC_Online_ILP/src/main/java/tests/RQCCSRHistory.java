...
//Loan paid to date summary
	...
	public static void historyverificationfee(String SSN,String AppURL) throws InterruptedException, ParseException
	{
	 ...
	 //ACH collateral details from sheet
			      if(ESign_CollateralType.equals("ACH"))
			      {
			       ...
			       String Bankruptcy=TestData.getCellData(sheetName,"Bankruptcy",row);	     
					...
					Thread.sleep(4000);
				//	test.log(LogStatus.INFO, MarkupHelper.createLabel("Transaction History validation has started", ExtentColor.BLUE));
					test.log(LogStatus.INFO, "Transaction History validation has started For Verification Fee");
			 ...
			 //Validations
							 ...
							 String verificationfee=driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[4]/table/tbody/tr[14]/td")).getText();
							 //test.log(LogStatus.PASS, "In history Screen Verification Fee is :" +verificationfee);
							 test.log(LogStatus.PASS, "<FONT color=green style=Arial> " +verificationfee);
