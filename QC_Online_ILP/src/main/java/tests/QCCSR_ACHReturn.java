...
public class QCCSR_ACHReturn extends QCStore {
	...
	public static void achreturn(String SSN, String AppURL) {
		try {
			...
			int lastrow = TestData.getLastRow("ACH_Return");
			String sheetName = "ACH_Return";
		...
		if(ESign_CollateralType.equalsIgnoreCase("ACH"))
		{
			...
			test.log(LogStatus.PASS, "Clicked on Payday Loan Link");
			...
			//test.log(LogStatus.PASS, "Return Transaction Completed Successfully");
			test.log(LogStatus.INFO, "<FONT color=green style=Arial>ACH Return Transaction Completed Successfully");
			driver.close();
			break;
					}
				}
