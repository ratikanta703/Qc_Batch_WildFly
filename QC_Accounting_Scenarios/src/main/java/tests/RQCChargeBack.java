...
public class RQCChargeBack extends QCStore
{
	...
	public static void chargeback(String SSN,String AppURL)
	{
		//int i;
		//for(i=0;i<3;i++)
		//{
	...
	try{
			...
			//==============================================================
					...
					test.log(LogStatus.PASS, "getting radio button name  as: " + Transaction);
					if (Transaction.equalsIgnoreCase("Buyback"))							
					{	
						driver.findElement(By.xpath("/html/body/form[1]/table/tbody/tr/td/table[2]/tbody/tr[3]/td/table/tbody/tr["+i+"]/td[1]/input")).click();
						test.log(LogStatus.PASS, "Clicked Radio button is : " + Transaction);
			...
			//==============================================================
					...
					Thread.sleep(1000);
				      ...
				      java.util.List<WebElement> oRadiobutton = driver.findElements(By.name("selRadio"));

				      // Create a boolean variable to store true/false.
				      Boolean is_selected = oRadiobutton.get(0).isSelected();
				      ...
				      if (is_selected == true) {
				    	  ...
				    	  oRadiobutton.get(3).click();
				    	  //test.log(LogStatus.FAIL, "Unable to click on radio button");
				      }
