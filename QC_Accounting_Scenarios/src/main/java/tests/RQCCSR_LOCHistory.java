...
public class RQCCSR_LOCHistory extends QCStore{
	...
	public static void lochistory(String SSN,String AppURL)
	{
		try{
					...
					List<WebElement> option=driver.findElements(By.xpath("//*[@id='revolvingCreditDetailsTable']/tbody/tr"));
						...
						//To read from application       
						       ach_history_ach_type= driver.findElement(locator(Rprop.getProperty("ach_history_ach_type"))).getText();
								...
								//ach_history_ach_effective_date= driver.findElement(locator(Rprop.getProperty("ach_history_ach_effective_date"))).getText();
					      }
...
public class RQCCSR_LOCHistory extends QCStore{
	//private static final String loan_paid_summary_repo_fee_paid2 = null;
	private static final String loan_paid_summary_repo_fee_paid = null;
	public static String ACH_type;
	public static String ACH_transaction;
	public static String ACH_status;
	public static String ACH_amount;
	 ...
	 //ACH collateral details from sheet
			 ...
			 //Validations
					...
					/*	String loan_balance_inf_principal_bal= driver.findElement(locator(Rprop.getProperty("loan_balance_inf_principal_bal"))).getText();
						...
						String loan_account_inf_loan_amt= driver.findElement(locator(Rprop.getProperty("loan_account_inf_loan_amt"))).getText();
						String loan_account_inf_loc_amount= driver.findElement(locator(Rprop.getProperty("loan_account_inf_loc_amount"))).getText().trim();
						String loan_account_inf_interest_rate= driver.findElement(locator(Rprop.getProperty("loan_account_inf_interest_rate"))).getText();
						String loan_account_inf_loan_date= driver.findElement(locator(Rprop.getProperty("loan_account_inf_loan_date"))).getText();
						
						//String loan_account_inf_collateral_type= driver.findElement(locator(Rprop.getProperty("loan_account_inf_collateral_type"))).getText();
						String loan_account_inf_collateral_type= driver.findElement(By.xpath("//*[@id='revolvingCreditHistTable']/tbody/tr/td[4]/table/tbody/tr[9]/td/span[2]")).getText();
						String loan_account_inf_loan_frequency= driver.findElement(By.xpath("//*[@id='revolvingCreditHistTable']/tbody/tr/td[4]/table/tbody/tr[10]/td/span[2]")).getText();
					
						String loan_account_inf_origination= driver.findElement(locator(Rprop.getProperty("loan_account_inf_origination"))).getText();
						//String loan_account_inf_available_credit= driver.findElement(locator(Rprop.getProperty("loan_account_inf_available_credit"))).getText();
						String loan_account_inf_available_credit= driver.findElement(By.xpath("//*[@id='revolvingCreditHistTable']/tbody/tr/td[4]/table/tbody/tr[12]/td/span[2]")).getText();
						String cust_underwriting_veritec_tran_nbr= driver.findElement(locator(Rprop.getProperty("cust_underwriting_veritec_tran_nbr"))).getText();
						/*String cust_underwriting_mla_status= driver.findElement(locator(Rprop.getProperty("cust_underwriting_mla_status"))).getText();
						String cust_underwriting_ofac_status= driver.findElement(locator(Rprop.getProperty("cust_underwriting_ofac_status"))).getText();
						String cust_promotion_campaign_name= driver.findElement(locator(Rprop.getProperty("cust_promotion_campaign_name"))).getText();
...
//Loan paid to date summary
					...
					/*	String loc_history_transaction_test= driver.findElement(locator(Rprop.getProperty("loc_history_transaction"))).getText();
						...
						String loan_status_inf_latest_payment_date= driver.findElement(locator(Rprop.getProperty("loan_status_inf_latest_payment_date"))).getText();
						//String loan_account_inf_min_pay_amt= driver.findElement(locator(Rprop.getProperty("loan_account_inf_min_pay_amt"))).getText();
						String loan_account_inf_min_pay_amt= driver.findElement(By.xpath("//*[@id='statementsGeneratedTable']/tbody/tr[2]/td[3]")).getText();
						
						String loan_paid_summary_total_paid_amt= driver.findElement(locator(Rprop.getProperty("loan_paid_summary_total_paid_amt"))).getText();
				//============================
						/*
						if(Rcsr_url.equals("https://qclocalreg.qfund.net/cc/demoIndex.do")){
							String loan_paid_summary_repo_fee_paid2=driver.findElement(By.xpath("//*[@id='revolvingCreditHistTable']/tbody/tr/td[3]/table/tbody/tr[30]/td/span[2]/span")).getText();
							                                                                     //*[@id="revolvingCreditHistTable"]/tbody/tr/td[3]/table/tbody/tr[30]/td/span[2]/span
					...
					//=============================
						...
						String loan_paid_summary_repo_fee_paid=driver.findElement(By.xpath("//*[@id='revolvingCreditHistTable']/tbody/tr/td[3]/table/tbody/tr[30]/td/span[2]/span")).getText();
						//String loan_paid_summary_repo_fee_paid2=driver.findElement(By.xpath("//*[@id='revolvingCreditHistTable']/tbody/tr/td[3]/table/tbody/tr[30]/td/span[2]/span")).getText();
						...
						String loan_balance_inf_Remaining_Min_Payment_Amount= driver.findElement(locator(Rprop.getProperty("loan_balance_inf_Remaining_Min_Payment_Amount"))).getText();
						//String loan_balance_inf_Statement_Payment_Amount=driver.findElement(locator(Rprop.getProperty("loan_balance_inf_Statement_Payment_Amount"))).getText();
						String loan_balance_inf_Statement_Payment_Amount=driver.findElement(By.xpath("//*[@id='revolvingCreditHistTable']/tbody/tr/td[3]/table/tbody/tr[20]/td/span[2]")).getText();
						//String loan_balance_inf_Current_Principal_Balance=driver.findElement(locator(Rprop.getProperty("loan_balance_inf_Current_Principal_Balance"))).getText();
						String loan_balance_inf_Current_Principal_Balance=driver.findElement(By.xpath("//*[@id='revolvingCreditHistTable']/tbody/tr/td[3]/table/tbody/tr[21]/td/span[2]")).getText();
...
/*						String cust_doc_total_amount= driver.findElement(locator(Rprop.getProperty("cust_doc_total_amount"))).getText();
	...
	//------------------------						
		...
		//Loan Balance Summary
                          ...
                          //=================
							/*if(repo_fee_paid.equalsIgnoreCase(loan_paid_summary_repo_fee_paid2))
							{
								test.log(LogStatus.PASS, "repo_fee_paid->Expected value:"+repo_fee_paid +"; == Actual value:"+loan_paid_summary_repo_fee_paid2);
							}
							else
							{
								test.log(LogStatus.FAIL, "repo_fee_paid->Expected value:"+repo_fee_paid +"; not equals to Actual value:"+loan_paid_summary_repo_fee_paid2);
