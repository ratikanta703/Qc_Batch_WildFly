...
public class QCCSR_ACHClear extends QCStore{
	...
	public static void achclearDropDown(String SSN,String AppURL)
	{
		...
		try{
			...
			//ExcelNew TestData = new ExcelNew(System.getProperty("user.dir")+prop.getProperty("QC_Store_NewLoan_Test_data_sheet_path")+FileName+".xls");  		 
				int lastrow=TestData.getLastRow("ACH_Clear");
				String sheetName="ACH_Clear";
						   ...
						   driver.switchTo().defaultContent();
								...
								
							{
								for( String winHandle1 : driver.getWindowHandles())
								{
								 ...
								 driver.switchTo().frame("mainFrame");
								 driver.switchTo().frame("main");
								 driver.findElement(By.name("transactionList")).sendKeys(ESign_CollateralType+" Clear");
								 test.log(LogStatus.PASS, "Transaction type is selected "+ESign_CollateralType+" Clear");
								...
								test.log(LogStatus.PASS, "<FONT color=green style=Arial> ACH Clear from CSR is successfull ");
