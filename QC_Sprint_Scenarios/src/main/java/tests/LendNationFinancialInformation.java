...
public class LendNationFinancialInformation extends QCStore {
	...
	test.log(LogStatus.INFO, "*******Lend Nation application navigated to Financial Information page*******");
		 ...
		 // wait.until(ExpectedConditions.elementToBeClickable( driver.findElement(locator(prop.getProperty("employer_phone_no")))));
		  ...
		  Thread.sleep(500);
		 /* String DOHire[] =HireDate.split("/");
	        String DOHire1 = DOHire[0];
	        String DOHire2 = DOHire[1];
	        String DOHire3 = DOHire[2];
	        Thread.sleep(500);
	        driver.findElement(By.name("hireBenefitMonth")).sendKeys(DOHire1);
	        test.log(LogStatus.PASS, "Date of Hire Month  is  :" + DOHire1);
	        Thread.sleep(200);
	        driver.findElement(By.name("hireBenefitDay")).sendKeys(DOHire2);
	        test.log(LogStatus.PASS, "Date of Hire Date  is  :" + DOHire2);
	        Thread.sleep(200);
	        driver.findElement(By.name("hireBenefitYear")).sendKeys(DOHire3);
	        test.log(LogStatus.PASS, "Date of Hire Year  is  :" + DOHire3);*/
