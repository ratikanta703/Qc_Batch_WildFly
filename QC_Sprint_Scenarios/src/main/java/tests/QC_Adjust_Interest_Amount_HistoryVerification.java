					 ...
					 driver.switchTo().defaultContent();
					   ...
					   test.log(LogStatus.PASS, "Clicked on Go button under Loans section");
						...
						System.out.println(Adjusted_Amount);
						 //================================					
			//String Updated_Adjusted_Amount="8.78";
						char ch1 = Updated_Adjusted_Amount.charAt(0);
						char ch2 = Updated_Adjusted_Amount.charAt(1);
				
						//String val=Character.toString(Updated_Adjusted_Amount.charAt(0));
						...
						if(Adjusted_Amount.equalsIgnoreCase(val)){						
							 test.log(LogStatus.PASS, "<FONT color=green style=Arial>In History Screen Adjusted Interest Amount is same as decreaded amount");
							 System.out.println(Adjusted_Amount);										
							 Thread.sleep(1000);										
							 break;
							 } 
