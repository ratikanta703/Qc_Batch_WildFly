		...
		try {
			...
			for (int row = 2; row <= lastrow; row++) {
				...
				if (SSN.equals(RegSSN)) {
					...
					//==========================================================================
							String Due_Amount=driver.findElement(By.name("requestBean.totalOwed")).getAttribute("value");
							test.log(LogStatus.PASS, "Due Amount Amount is :"+Due_Amount);
							 double d = Double.parseDouble(Due_Amount);
							   double dd=d-50;
							       //double to string 	       
							   String DefaultPaymentAmount=String.valueOf(dd);  
							   System.out.println(DefaultPaymentAmount);
							   
							   Thread.sleep(1000);
							  
							   driver.findElement(By.name("requestBean.paymentAmt")).sendKeys(Keys.chord(Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE)+DefaultPaymentAmount);
							   Thread.sleep(500);
							   test.log(LogStatus.PASS, "Default Payment amount Less than Due amount entered as "+DefaultPaymentAmount); 
							   Thread.sleep(1000);
					...
					//=========================================================================													
							...
							driver.findElement(By.name("requestBean.tenderAmt")).sendKeys(DefaultPaymentAmount);
							test.log(LogStatus.PASS, "Tender amount entered as :" + DefaultPaymentAmount);
							...
							test.log(LogStatus.PASS, "Clicked on Confirmed Yes Button");
							Thread.sleep(3000);*/
							test.log(LogStatus.PASS, "<FONT color=green style=Arial>Default Payment Less than Due amount Transaction Completed Successfully");
