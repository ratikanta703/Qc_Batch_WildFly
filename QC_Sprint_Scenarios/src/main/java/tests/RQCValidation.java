...
public class RQCValidation extends QCStore{
	

	public static void validation(String SSN,String AppURL){
					...
					for(int row=2;row<=lastrow;row++)
							{		
						       ...
						       Thread.sleep(4000);
								...
								test.log(LogStatus.INFO, "Data Validation From DB has been initiated");
									    ...
									    for(String winHandle : driver.getWindowHandles()){
									        ...
									        RDBValidation.dbvalidation();
												...
												// test.log(LogStatus.PASS, MarkupHelper.createLabel("Clicked on Scheduler Ok Successfully",ExtentColor.GREEN));
												 test.log(LogStatus.PASS,"Validation From Data Base Completed Successfully");
