...
public class QCCSRPartial_DefaultPayment {
...
public class QCCSRPartial_DefaultPayment extends QCStore {
	...
	public static void tlppartialdefaultpayment(String SSN, String AppURL) {
		try {
			int lastrow = TestData.getLastRow("Partial_DefaultPayment");
			String sheetName = "Partial_DefaultPayment";
				...
				if (SSN.equals(RegSSN)) {
					...
					for (String winHandle : driver.getWindowHandles()) {
						...
						if (Balance_Status.trim().equalsIgnoreCase(BalanceStatus.trim())) {
							...
							test.log(LogStatus.PASS, "Clicked on DefaultPayment Successfull No button for another transaction");
							Thread.sleep(500);
							test.log(LogStatus.PASS, "<FONT color=green style=Arial>Partial Default Payment Transaction Completed Successfully");
							Thread.sleep(5000);
	...
	public static void ilppartialdefaultpayment(String SSN, String AppURL) {
		try {
			int lastrow = TestData.getLastRow("Partial_DefaultPayment");
			String sheetName = "Partial_DefaultPayment";
