...
public class QCCSR_LOC_ManualDefault extends QCStore{
	...
	public static void pdlmanualdefault(String SSN,String AppURL){
	...
	public static void nvtlp_manualdefault(String SSN,String AppURL){
								...
								for(String winHandle : driver.getWindowHandles()){
									 ...
									 driver.switchTo().defaultContent();
									   ...
									   //  String loan_nbr= driver.findElement(locator(prop.getProperty("csr_loan_nbr"))).getText();
									    ...
									    customer_number=driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[1]/table/tbody/tr[3]/td/span[2]/span")).getText();
								        test.log(LogStatus.PASS, "Customer Nbr is :" +customer_number);
	...
	public static void ilp_manualdefault(String SSN,String AppURL){
