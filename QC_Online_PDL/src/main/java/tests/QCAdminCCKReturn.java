				...
				if (SSN.equals(RegSSN)) {
					...
					driver.get(RAdminURL);
					 Thread.sleep(1000);
						...
						Thread.sleep(1000);
					test.log(LogStatus.INFO,"Opened the Admin URL"+ RAdminURL);
					test.log(LogStatus.INFO,"Reading encryption details from Admin has initiated"+ RAdminURL);
