...
public class LendNationPersonalInformation extends QCStore{
	...
	//=============== For Martial Status Only For Winscon State ===============================
	 ...
	 // break;
	  ...
	  public static void id_personalInformation(String SSN,String AppURL) throws Exception
	...
	//=============== For Martial Status Only For Winscon State ===============================
	 ...
	 // break;
	  ...
	  public static void nv_personalInformation(String SSN,String AppURL) throws Exception
