...
public class QCCSR_Void extends QCStore{
	
	public static void Ref_Ilp_Void(String SSN,String AppURL) throws Exception
	{
					...
					Thread.sleep(800);			    
					    ...
					    Thread.sleep(800);					    
						 ...
						 Thread.sleep(10000);
							 ...
							 else if(Scenario.equalsIgnoreCase("TLPRefinance_Void"))
							 {
							 ...
							 else if(Scenario.equalsIgnoreCase("ILPRefinance_Void"))
							 {
								 driver.findElement(By.name("tenderType")).sendKeys(TenderType);
								 test.log(LogStatus.PASS, "Tender type is entered as "+TenderType);
								 driver.findElement(By.name("requestBean.password")).sendKeys(PIN);
	...
	public static void Conv_Ilp_Void(String SSN,String AppURL) throws Exception
	{
		/*int i;
		for(i=0;i<3;i++)
		{
					...
					test.log(LogStatus.PASS, "Clicked on Go button under search results");
					    ...
					    test.log(LogStatus.PASS, "Clicked on Go button under Loans section");
						 ...
						 Thread.sleep(10000);
							 ...
							 else if(Scenario.equalsIgnoreCase("TLPDefault_Void"))
							 {
								 driver.findElement(By.name("transactionDataBean.disbursementType")).sendKeys(TenderType);
								 test.log(LogStatus.PASS, "Disb type is entered as "+TenderType);
								 driver.findElement(By.name("transactionDataBean.password")).sendKeys(PIN);
							 ...
							 else if(Scenario.equalsIgnoreCase("ILPDefault_Void"))
							 {
								 driver.findElement(By.name("transactionDataBean.disbursementType")).sendKeys(TenderType);
								 test.log(LogStatus.PASS, "Disb type is entered as "+TenderType);
								 driver.findElement(By.name("transactionDataBean.password")).sendKeys(PIN);
	...
	public static void refinancestepupVoid(String SSN,String AppURL) throws Exception
	{
		/*int i;
		for(i=0;i<3;i++)
		{
